 ...
 */
class Test1 extends \Scrumator\Bundle\BackendBundle\Entity\Test1 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'id', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'name', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'firstname', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'age', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'birthdate', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'civilite', '' . "\0" . 'Scrumator\\Bundle\\BackendBundle\\Entity\\Test1' . "\0" . 'ville');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Test1 $proxy) {
