...
use Scrumator\Bundle\BackendBundle\Entity\Civilite;
use Scrumator\Bundle\BackendBundle\Form\CiviliteType;
...
class CiviliteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScrumatorBackendBundle:Civilite')->findAll();
     ...
     * @Method("POST")
     * @Template("ScrumatorBackendBundle:Civilite:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScrumatorBackendBundle:Civilite')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ScrumatorBackendBundle:Civilite:edit.html.twig")
     */
