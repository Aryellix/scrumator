...
use Scrumator\Bundle\BackendBundle\Entity\Status;
use Scrumator\Bundle\BackendBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScrumatorBackendBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("ScrumatorBackendBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScrumatorBackendBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ScrumatorBackendBundle:Status:edit.html.twig")
     */
